data modify storage magick:data uuid_string set value {}
data modify storage magick:data concatenated_string set value ""

data modify storage magick:data uuid_string.str1 set string entity @s UUID[0]
...
data modify storage magick:data uuid_string.str1 set string storage magick:data concatenated_string
