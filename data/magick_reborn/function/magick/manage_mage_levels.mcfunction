...
execute as @s[scores={mageLevel=..1}, tag=Apprendice] run tag @s remove Apprendice
execute as @s[scores={mageLevel=..1}, tag=Adept] run tag @s remove Adept
execute as @s[scores={mageLevel=..1}, tag=Expert] run tag @s remove Expert
execute as @s[scores={mageLevel=..1}, tag=Master] run tag @s remove Master
execute as @s[scores={mageLevel=..1}, tag=Archmage] run tag @s remove Archmage
execute as @s[scores={mageLevel=..1}, tag=Elementalist] run tag @s remove Elementalist
execute as @s[scores={mageLevel=..1}, tag=Sorcerer] run tag @s remove Sorcerer
execute as @s[scores={mageLevel=..1}, tag=Warlock] run tag @s remove Warlock
execute as @s[scores={mageLevel=..1}, tag=Grandmaster] run tag @s remove Grandmaster
execute as @s[scores={mageLevel=..1}, tag=Supreme] run tag @s remove Supreme
...
# Nível 91-100
execute as @s[scores={mageLevel=91..100}, tag=!Supreme] run tellraw @s {"text":"You have ascended to the Supreme Mage. None rival your power!"}
execute as @s[scores={mageLevel=91..100}, tag=!Supreme] run scoreboard players set @s baseMaxMagick 500
execute as @s[scores={mageLevel=91..100}, tag=!Supreme] run scoreboard players set @s baseMagickRegen 11
execute as @s[scores={mageLevel=91..100}] run tag @s add Supreme
