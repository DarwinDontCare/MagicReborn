...
execute unless score @s baseMaxActiveSummons matches 1.. run scoreboard players set @s baseMaxActiveSummons 10
...
execute if data entity @s equipment.head.components."minecraft:enchantments"."magick_reborn:magick_regen" run function magick_reborn:magick/apply_modifiers {path: "equipment.head.components.\"minecraft:enchantments\".\"magick_reborn:boost_summon\"", score: "maxActiveSummonsMod", multiplier: 1}
execute if data entity @s equipment.chest.components."minecraft:enchantments"."magick_reborn:magick_regen" run function magick_reborn:magick/apply_modifiers {path: "equipment.chest.components.\"minecraft:enchantments\".\"magick_reborn:boost_summon\"", score: "maxActiveSummonsMod", multiplier: 1}
execute if data entity @s equipment.legs.components."minecraft:enchantments"."magick_reborn:magick_regen" run function magick_reborn:magick/apply_modifiers {path: "equipment.legs.components.\"minecraft:enchantments\".\"magick_reborn:boost_summon\"", score: "maxActiveSummonsMod", multiplier: 1}
execute if data entity @s equipment.feet.components."minecraft:enchantments"."magick_reborn:magick_regen" run function magick_reborn:magick/apply_modifiers {path: "equipment.feet.components.\"minecraft:enchantments\".\"magick_reborn:boost_summon\"", score: "maxActiveSummonsMod", multiplier: 1}
...
scoreboard players operation @s calculationValues = @s baseMaxActiveSummons
scoreboard players operation @s calculationValues += @s maxActiveSummonsMod
scoreboard players operation @s maxActiveSummons = @s calculationValues

execute as @s if score @s magick < @s maxMagick run scoreboard players add @s magickRegenDelay 1

execute as @s if score @s magick < @s maxMagick if score @s magickRegenDelay matches 20.. unless score @s magickDrainTick matches 1 run scoreboard players operation @s magick += @s magickRegen
