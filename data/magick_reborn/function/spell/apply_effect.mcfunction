...
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/equipment/summon_armor {duration: $(duration), amplifier: $(amplifier)}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}

data modify storage magick:data effectComparer set value "minecraft:summon_bow"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/equipment/summon_weapon {duration: $(duration), amplifier: $(amplifier), tool: "minecraft:bow", model: "magick_reborn:summoned_bow", name: "Summoned Bow"}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}

data modify storage magick:data effectComparer set value "minecraft:summon_sword"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/equipment/summon_weapon {duration: $(duration), amplifier: $(amplifier), tool: "minecraft:wooden_sword", model: "magick_reborn:summoned_sword", name: "Summoned Sword"}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}

#Summon Tools
data modify storage magick:data effectComparer set value "minecraft:summon_pickaxe"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/equipment/summon_tool {duration: $(duration), amplifier: $(amplifier), tool: "minecraft:wooden_pickaxe", model: "magick_reborn:summoned_pickaxe", name: "Summoned Pickaxe"}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}

data modify storage magick:data effectComparer set value "minecraft:summon_axe"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/equipment/summon_tool {duration: $(duration), amplifier: $(amplifier), tool: "minecraft:wooden_axe", model: "magick_reborn:summoned_axe", name: "Summoned Axe"}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}

data modify storage magick:data effectComparer set value "minecraft:summon_shovel"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/equipment/summon_tool {duration: $(duration), amplifier: $(amplifier), tool: "minecraft:wooden_shovel", model: "magick_reborn:summoned_shovel", name: "Summoned Shovel"}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}

data modify storage magick:data effectComparer set value "minecraft:summon_hoe"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/equipment/summon_tool {duration: $(duration), amplifier: $(amplifier), tool: "minecraft:wooden_hoe", model: "magick_reborn:summoned_hoe", name: "Summoned Hoe"}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}

#Destruction Spells
data modify storage magick:data effectComparer set value "minecraft:frostbite"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/frostbite/frostbite {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), range: 100}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}

data modify storage magick:data effectComparer set value "minecraft:ice_wall"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/ice_wall {duration: $(duration), amplifier: $(amplifier), caster_id: $(caster_id)}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}

data modify storage magick:data effectComparer set value "minecraft:glowing"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 if score #BlockDetect boolean matches 1 run return run function magick_reborn:spell/cast/light {duration: $(duration), amplifier: $(amplifier)}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}

data modify storage magick:data effectComparer set value "minecraft:lightning_bolt"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/lightning_bolt {uuid: $(caster_id), amplifier: $(amplifier)}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}

data modify storage magick:data effectComparer set value "minecraft:sonic_boom"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/sonic_boom {uuid: $(caster_id), amplifier: $(amplifier), range: 100}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}

data modify storage magick:data effectComparer set value "minecraft:flames"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/flames/flames {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), range: 100}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}

#Conjuration
data modify storage magick:data effectComparer set value "minecraft:web"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/web/web {duration: $(duration), amplifier: $(amplifier)}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}}
...
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/prepare_size_data {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), function: "magick_reborn:spell/cast/giant/giant", scale: 0.5}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/prepare_size_data {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), function: "magick_reborn:spell/cast/giant/giant", scale: 0.5}

data modify storage magick:data effectComparer set value "minecraft:dwarf"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/prepare_size_data {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), function: "magick_reborn:spell/cast/dwarf/dwarf", scale: 0.2}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/prepare_size_data {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), function: "magick_reborn:spell/cast/dwarf/dwarf", scale: 0.2}

data modify storage magick:data effectComparer set value "minecraft:teleknesis"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/telekinesis/telekinesis {amplifier: $(amplifier), uuid: $(caster_id)}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/telekinesis/telekinesis {amplifier: $(amplifier), uuid: $(caster_id)}
...
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @e[predicate=!magick_reborn:ignore_entity,distance=..$(area),tag=!magick_projectile] unless data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/teleport {uuid: $(caster_id), amplifier: $(amplifier)}
$execute as @e[predicate=!magick_reborn:ignore_entity,sort=nearest,limit=1,tag=!magick_projectile] if data storage magick {$(caster_id): {cast_effect: {single_target: true}}} if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/teleport {uuid: $(caster_id), amplifier: $(amplifier)}
