...
$execute store result score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @s if score #Compare boolean matches 0 run return run function magick_reborn:spell/equipment/summon_weapon {duration: $(duration), amplifier: $(amplifier), tool: "minecraft:bow", model: "magick_reborn:summon_bow"}

data modify storage magick:data effectComparer set value "minecraft:summon_sword"
$execute store result score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @s if score #Compare boolean matches 0 run return run function magick_reborn:spell/equipment/summon_weapon {duration: $(duration), amplifier: $(amplifier), tool: "minecraft:wooden_sword", model: "magick_reborn:summon_sword"}

#Summon Tools
data modify storage magick:data effectComparer set value "minecraft:summon_pickaxe"
$execute store result score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @s if score #Compare boolean matches 0 run return run function magick_reborn:spell/equipment/summon_tool {duration: $(duration), amplifier: $(amplifier), tool: "minecraft:wooden_pickaxe", model: "magick_reborn:summon_pickaxe"}

data modify storage magick:data effectComparer set value "minecraft:summon_axe"
$execute store result score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @s if score #Compare boolean matches 0 run return run function magick_reborn:spell/equipment/summon_tool {duration: $(duration), amplifier: $(amplifier), tool: "minecraft:wooden_axe", model: "magick_reborn:summon_axe"}
