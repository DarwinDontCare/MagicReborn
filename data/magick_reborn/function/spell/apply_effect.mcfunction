...
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @s if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/summon_creature {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), index: 1, x: 0, proportion: 1, mob: "zombie", sound: "entity.zombie.converted_to_drowned", equipment: "{head:{id:leather_helmet}}", range: 15, nbt: ""}

data modify storage magick:data effectComparer set value "minecraft:summon_blaze"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @s if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/summon_creature {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), index: 1, x: 0, proportion: 2, mob: "blaze", sound: "minecraft:item.firecharge.use", equipment: "{}", range: 15, nbt: ""}

data modify storage magick:data effectComparer set value "minecraft:summon_wither_skeleton"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @s if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/summon_creature {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), index: 1, x: 0, proportion: 2, mob: "wither_skeleton", sound: "minecraft:item.firecharge.use", equipment: "{mainhand:{id:stone_sword}}", range: 15, nbt: ""}

data modify storage magick:data effectComparer set value "minecraft:summon_creeper"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @s if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/summon_creature {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), index: 1, x: 0, proportion: 3, mob: "creeper", sound: "minecraft:entity.creeper.death", equipment: "{}", range: 15, nbt: ""}

data modify storage magick:data effectComparer set value "minecraft:summon_ghast"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @s if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/summon_creature {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), index: 1, x: 0, proportion: 4, mob: "ghast", sound: "minecraft:block.dried_ghast.break", equipment: "{}", range: 50, nbt: ""}

data modify storage magick:data effectComparer set value "minecraft:summon_iron_golem"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @s if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/summon_creature {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), index: 1, x: 0, proportion: 4, mob: "iron_golem", sound: "minecraft:block.anvil.place", equipment: "{}", range: 0, nbt: ""}

data modify storage magick:data effectComparer set value "minecraft:summon_wolf"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @s if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/summon_creature {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), index: 1, x: 0, proportion: 2, mob: "wolf", sound: "minecraft:entity.wolf.growl", equipment: "{}", range: 0, nbt: ""}

data modify storage magick:data effectComparer set value "minecraft:summon_snow_golem"
$execute store success score #Compare boolean run data modify storage magick:data effectComparer set value "$(effect)"
$execute as @s if score #Compare boolean matches 0 run return run function magick_reborn:spell/cast/summon_creature {duration: $(duration), amplifier: $(amplifier), uuid: $(caster_id), index: 1, x: 0, proportion: 1, mob: "snow_golem", sound: "minecraft:block.snow.place", equipment: "{}", range: 0, nbt: ""}
