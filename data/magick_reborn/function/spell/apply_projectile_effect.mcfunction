...
$data modify storage magick:data effectIterator.nbt_path set value "entity @e[tag=magick_projectile, distance=..$(range), sort=nearest, limit=1, nbt={data: {caster_id: $(caster_id)}}] data.effects"
