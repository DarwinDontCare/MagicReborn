...
$execute if data entity @s {data:{dimension:"minecraft:the_nether"}} if entity @a[scores={uuid=$(uuid)},advancements={story/enter_the_end=true}] run data modify entity @s data merge value {exit_pos_x: "6", exit_pos_y: "50", exit_pos_z: "0"}
...
$execute if data entity @s {data:{dimension:"minecraft:the_nether"}} if entity @a[scores={uuid=$(uuid)},advancements={story/enter_the_end=false}] run data modify entity @s data merge value {exit_pos_x: "~", exit_pos_y: "~", exit_pos_z: "~"}
...
execute if data entity @s {data:{dimension:"minecraft:overworld"}} run data modify entity @s data merge value {exit_pos_x: "~", exit_pos_y: "~", exit_pos_z: "~"}
