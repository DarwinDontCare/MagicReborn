...
execute if score @s ticksCount matches ..0 at @e[type=item_display,tag=plane_shift,sort=nearest,limit=1] run particle reverse_portal ~ ~ ~ 0.1 0.1 0.1 0.1 30 force @a
