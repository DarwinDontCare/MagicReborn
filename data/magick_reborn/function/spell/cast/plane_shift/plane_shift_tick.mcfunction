...
execute as @e[type=interaction,nbt={interaction:{}},sort=nearest,tag=plane_shift] at @s run function magick_reborn:spell/cast/plane_shift/portal_interact with entity @s interaction
execute as @e[type=interaction,sort=nearest,tag=plane_shift] run data modify entity @s interaction set value {}
