$execute positioned 0.0 -64.0 0.0 rotated as @s run summon armor_stand ^$(x) ^$(y) ^$(z) {Invisible:true, Invulnerable:true, NoGravity:true, Tags:["motion_direction"], data: {caster_id: $(uuid)}}
