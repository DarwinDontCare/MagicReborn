...
execute if entity @s[type=player] if score #global summonCheckTimer matches 20.. run data modify storage magick:data bossbarId set value {}
...
execute if entity @s[type=player] if score #global summonCheckTimer matches 20.. run data modify storage magick:data bossbarId.str2 set string storage magick:data uuid_string
