...
execute if score #global summonCheckTimer matches 20.. store result storage magick:data spectralFormEffect.value int 1 run scoreboard players get @s shieldEffectDuration
$execute if score #global summonCheckTimer matches 20.. run data modify storage magick:data spectralFormEffect.bossbarId set value $(uuid)
