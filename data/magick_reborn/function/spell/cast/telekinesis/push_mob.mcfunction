$execute rotated as @a[scores={uuid=$(uuid)},limit=1] positioned 0 0 0 align xyz run summon minecraft:armor_stand ^ ^ ^1 {Invisible: true, Invulnerable:1b,NoGravity:1b,Tags:["aim"]}
