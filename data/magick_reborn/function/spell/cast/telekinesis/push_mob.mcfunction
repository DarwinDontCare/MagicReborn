...
execute positioned 0 -64 0 store result score @s MotionX run data get entity @e[tag=aim,limit=1] Pos[0] 100
execute positioned 0 -64 0 store result score @s MotionY run data get entity @e[tag=aim,limit=1] Pos[1] 100
execute positioned 0 -64 0 store result score @s MotionZ run data get entity @e[tag=aim,limit=1] Pos[2] 100
