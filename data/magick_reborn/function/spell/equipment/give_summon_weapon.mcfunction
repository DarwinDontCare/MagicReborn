...
$execute if score #Compare boolean matches 0 unless entity @s[nbt={Inventory:[{id:"minecraft:arrow"},{components:{"minecraft:custom_data":{summon_type: "$(tool)"}}}]}] run give @s arrow
