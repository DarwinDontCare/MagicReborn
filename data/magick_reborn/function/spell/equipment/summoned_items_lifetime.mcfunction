execute as @s[nbt={equipment:{head:{components:{"minecraft:custom_data":{summoned: true}}}}}] if score #global ticksCount matches 9.. run item modify entity @s armor.head magick_reborn:damage_item

execute as @s[nbt={equipment:{chest:{components:{"minecraft:custom_data":{summoned: true}}}}}] if score #global ticksCount matches 9.. run item modify entity @s armor.chest magick_reborn:damage_item

execute as @s[nbt={equipment:{legs:{components:{"minecraft:custom_data":{summoned: true}}}}}] if score #global ticksCount matches 9.. run item modify entity @s armor.legs magick_reborn:damage_item

execute as @s[nbt={equipment:{feet:{components:{"minecraft:custom_data":{summoned: true}}}}}] if score #global ticksCount matches 9.. run item modify entity @s armor.feet magick_reborn:damage_item
