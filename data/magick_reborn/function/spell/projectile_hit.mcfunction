...
$execute at @s[tag=!fireball] unless block ^ ^ ^.5 #magick_reborn:ignore_colision run return run function magick_reborn:spell/apply_projectile_effect {caster_id: $(caster_id), range: 1, hit_block: 1, particle: "$(particle)", hit_sound: "$(hit_sound)", magick_circle: "$(magick_circle)", is_burst: $(is_burst)}
$execute at @s[tag=!fireball] unless block ^ ^-.5 ^.5 #magick_reborn:ignore_colision run return run function magick_reborn:spell/apply_projectile_effect {caster_id: $(caster_id), range: 1, hit_block: 1, particle: "$(particle)", hit_sound: "$(hit_sound)", magick_circle: "$(magick_circle)", is_burst: $(is_burst)}
$execute at @s[tag=!fireball] unless block ^ ^.5 ^.5 #magick_reborn:ignore_colision run return run function magick_reborn:spell/apply_projectile_effect {caster_id: $(caster_id), range: 1, hit_block: 1, particle: "$(particle)", hit_sound: "$(hit_sound)", magick_circle: "$(magick_circle)", is_burst: $(is_burst)}
...
$execute at @s as @e[distance=..1.5, sort=nearest, tag=!magick_projectile, predicate=!magick_reborn:ignore_entity, tag=!frostbite, tag=!ice_wall_marker, tag=!magick_circle] unless entity @s[scores={uuid=$(caster_id)}] run return run function magick_reborn:spell/apply_projectile_effect {caster_id: $(caster_id), range: 1.5, hit_block: 0, particle: "$(particle)", hit_sound: "$(hit_sound)", magick_circle: "$(magick_circle)", is_burst: $(is_burst)}
$execute at @s[nbt={data:{effects:[{effect: "minecraft:plane_shift"}]}}] as @e[distance=..1.5, sort=nearest, tag=plane_shift] run return run function magick_reborn:spell/apply_projectile_effect {caster_id: $(caster_id), range: 1.5, hit_block: 0, particle: "$(particle)", hit_sound: "$(hit_sound)", magick_circle: "$(magick_circle)", is_burst: $(is_burst)}
...
$execute as @s[tag=magick_projectile, scores={projectileHealth=..0}] at @s run return run function magick_reborn:spell/apply_projectile_effect {caster_id: $(caster_id), range: 1.5, hit_block: 0, particle: "$(particle)", hit_sound: "$(hit_sound)", magick_circle: "$(magick_circle)", is_burst: $(is_burst)}
