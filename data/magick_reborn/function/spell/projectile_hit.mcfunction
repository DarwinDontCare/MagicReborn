...
$execute as @s[tag=magic_projectile, scores={projectileHealth=..0}] at @s run return run function magick_reborn:spell/apply_projectile_effect {caster_id: $(caster_id), range: 1.5, hit_block: 0, particle: "$(particle)", area: 2, hit_sound: "$(hit_sound)"}
