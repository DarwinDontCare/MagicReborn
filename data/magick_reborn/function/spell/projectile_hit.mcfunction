...
$execute at @s[tag=!fireball] unless block ^ ^ ^.5 #magick_reborn:ignore_colision run return run function magick_reborn:spell/apply_projectile_effect {caster_id: $(caster_id), range: 1, hit_block: 1, particle: "$(particle)", area: 2}
$execute at @s[tag=!fireball] unless block ^ ^-.5 ^.5 #magick_reborn:ignore_colision run return run function magick_reborn:spell/apply_projectile_effect {caster_id: $(caster_id), range: 1, hit_block: 1, particle: "$(particle)", area: 2}
$execute at @s[tag=!fireball] unless block ^ ^.5 ^.5 #magick_reborn:ignore_colision run return run function magick_reborn:spell/apply_projectile_effect {caster_id: $(caster_id), range: 1, hit_block: 1, particle: "$(particle)", area: 2}
