...
$function magick_reborn:spell/spell_creation_menu/calculate_spell_cost {uuid: $(uuid), current_effect_slot: $(current_effect_slot), effect: "$(effect)", duration: $(duration), amplifier: $(amplifier), area: $(area)}
