...
$execute unless score #LoreGenerator index matches 1.. run data modify storage magick $(uuid).spell_creation.lore set value []

$execute unless data storage magick $(uuid).spell_creation.spell_effects[$(index)] run return run data modify storage magick $(uuid).spell_creation.lore append value "Cost: $(magick_cost)"

$function magick_reborn:utils/get_effect_info with storage magick $(uuid).spell_creation.spell_effects[$(index)]
...
data modify storage magick:data lore_text.str2 set value " (Dur: "
...
$data modify storage magick:data lore_text.str2 set from storage magick $(uuid).spell_creation.spell_effects[$(index)].duration
function magick_reborn:data/concatenate_string with storage magick:data lore_text

data modify storage magick:data lore_text.str1 set from storage magick:data concatenated_string
data modify storage magick:data lore_text.str2 set value ", Amp: "
function magick_reborn:data/concatenate_string with storage magick:data lore_text
data modify storage magick:data lore_text.str1 set from storage magick:data concatenated_string
$data modify storage magick:data lore_text.str2 set from storage magick $(uuid).spell_creation.spell_effects[$(index)].amplifier
function magick_reborn:data/concatenate_string with storage magick:data lore_text

data modify storage magick:data lore_text.str1 set from storage magick:data concatenated_string
data modify storage magick:data lore_text.str2 set value ", Are: "
function magick_reborn:data/concatenate_string with storage magick:data lore_text
data modify storage magick:data lore_text.str1 set from storage magick:data concatenated_string
$data modify storage magick:data lore_text.str2 set from storage magick $(uuid).spell_creation.spell_effects[$(index)].area
function magick_reborn:data/concatenate_string with storage magick:data lore_text
...
$data modify storage magick $(uuid).spell_creation.lore append from storage magick:data concatenated_string
