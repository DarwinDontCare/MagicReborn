...
data modify storage magick:data macroGenerator.function set value "magick_reborn:spell/spell_selection/define_quick_spells"
...
data modify storage magick:data spellObject.exit_action set value {\
    ...
    action: {\
        type: "dynamic/run_command",\
        template: "function magick_reborn:spell/spell_selection/open_known_spells {dummy $(dummy)}"\
    }\
}
