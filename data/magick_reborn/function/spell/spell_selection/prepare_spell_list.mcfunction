...
execute if score #ParseSpellList index matches 0 run data modify storage magick:data spellList.spells_define set value []
...
$data modify storage magick:data macroVars set value {index: $(index)}
...
# Define
data modify storage magick:data spellList.spells_define append value {initial: false, action: {type: "dynamic/run_command"}}
data modify storage magick:data spellList.spells_define[-1].label set from storage magick:data spellObject.label
data modify storage magick:data spellList.spells_define[-1].tooltip set from storage magick:data spellObject.lore
data modify storage magick:data spellList.spells_define[-1].id set from storage magick:data spellObject.id

$data modify storage magick:data macroVars set value $(vars)
$data modify storage magick:data macroVars.index set value $(index)
data modify storage magick:data macroVars.id set from storage magick:data spellObject.id
$data modify storage magick:data macroVars.uuid set value $(uuid)
data modify storage magick:data stringfy.string_value set from storage magick:data macroVars
...
data modify storage magick:data macroGenerator.function set value "magick_reborn:spell/spell_selection/change_quick_spell"
data modify storage magick:data macroGenerator.variables set string storage magick:data string_value 0 -1
data modify storage magick:data macroGenerator.var set value "text: \\\"$(text)\\\""
function magick_reborn:spell/spell_selection/generate_macro with storage magick:data macroGenerator

data modify storage magick:data spellList.spells_define[-1].action.template set from storage magick:data macroGenerator.template
...
$data modify storage magick:data PrepareSpellList.vars set value $(vars)
